...
- [x] Тестирование с реальными Rutube видео
...
- [x] Протестировать с реальным видео из Yandex Cloud
- [x] Добавлен в demo страницу
- [x] Origin validation: использует `Array.includes()` для точного совпадения — безопасно
...
- [x] Унифицирован формат postMessage команд через base-embed.js
- [x] Протестировать с реальным видео Mail.ru
- [x] Добавлен в demo страницу
...
- ✅ Все провайдеры протестированы с реальными видео
...
- ✅ Изменения синхронизированы с main branch
- ✅ Повторная проверка выполнена 2026-05-05 20:30 МСК (сборка, тесты, линтинг)
...
- ✅ Последняя проверка: сборка и тесты прошли успешно (2026-05-05 20:28 МСК)
