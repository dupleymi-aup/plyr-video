...
Plyr поддерживает интеграцию с российскими видеохостингами: **Rutube**, **Yandex Cloud Video**, **VK Video** и **Mail.ru Video**.
...
```html
<div class="plyr__video-embed" id="player">
  <iframe src="https://video.cloud.yandex.net/player/your-video-id" allowfullscreen allowtransparency allow="autoplay"></iframe>
</div>
```
...
- ✅ Получение заголовка видео
- ⚠️ Скорость воспроизведения (ограничена API)
- ⚠️ Субтитры (не поддерживаются API)
...
- ⚠️ Ограниченная поддержка функций (API недокументирован)
