...
- [x] Унифицировать формат postMessage команд между всеми провайдерами
  - Rutube/Yandex/VK: `{ type, data }` → `player:play`
...
- [x] Вынести дублирование кода в shared base-embed.js
  ...
  - VK и Mail.ru полностью рефакторинг — используют createEmbed с overrides
...
### Срочные задачи
- [ ] Протестировать все провайдеры с реальными видео
- [ ] Обновить документацию по российским видеохостингам
- [ ] Создать полноценную демо-страницу с примерами для всех провайдеров

### Дополнительные улучшения
- [ ] Добавить поддержку превью изображений для российских платформ
- [ ] Расширить поддержку субтитров для Mail.ru (если API будет доступен)
- [ ] Добавить поддержку дополнительных форматов воспроизведения
- [ ] Улучшить обработку ошибок для всех провайдеров